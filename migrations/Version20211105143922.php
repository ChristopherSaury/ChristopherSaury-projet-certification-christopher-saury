 ...
 */
final class Version20211105143922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dishes (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(45) NOT NULL, description VARCHAR(80) NOT NULL, price DOUBLE PRECISION NOT NULL, url VARCHAR(255) NOT NULL, quantity INT DEFAULT NULL, INDEX IDX_584DD35D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
